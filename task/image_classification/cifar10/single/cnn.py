...
def get_basenet_config(cnn_layer_num_per_stage: int = 6) -> Tuple[Dict[str, float], Dict[str, List[float]]]:
    '''
    ...
    param_specified: Dict[str, float] = {
        ...
        'cnn_layer_num_per_stage': float(cnn_layer_num_per_stage),
...
def get_basenet_test_config(cnn_layer_num_per_stage: int = 6) -> List[Dict[str, float]]:
    '''
    Get the configuration for the base network training.
    '''
